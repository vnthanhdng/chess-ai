"""
Run Q-Learning and Value Iteration agents on puzzles by theme and output results.
...
OUTPUT_FILE = "results/rl_theme_results.txt"
...
def run_theme_tests():
    ...
    with open(output_path, 'w') as f:
        ...
        f.write("Agents: Q-Learning, Value Iteration\n")
        f.write("=" * 70 + "\n")
        ...
        print("Agents: Q-Learning, Value Iteration")
        print("=" * 70)
        ...
        agents = [
            QLearningAgent(name="QLearning", color=chess.BLACK),
            ValueIterationAgent(discount=0.9, iterations=3, name="ValueIteration", color=chess.BLACK),
        ]
